...
describe('Unit test for explorer', () => {
    ...
    `(
        'should move forward to position $expectedPosition and facing $expectedDirection after turning $rightTurn times',
        ({ expectedDirection, expectedPosition, rightTurn }) => {
            for (let i = 0; i < rightTurn; i++) {
                explorer.turnRight();
            }
